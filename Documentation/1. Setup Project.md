...
👉 Separation of concerns is important for scalability.
...
✅ Why: Keeps Axios configuration in one place and automatically adds JWT token for authenticated requests.
...
👉 Must be placed before Authorization middleware.
